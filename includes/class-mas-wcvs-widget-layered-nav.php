 ...
 * @extends  WC_Widget
 */
class MAS_WCVS_Widget_Layered_Nav extends WC_Widget {
		...
		foreach ( $terms as $term ) {
			...
			switch ( $type ) {
				...
				case 'image':
					...
					$swatch_html = sprintf( '<img src="%1$s" alt="%2$s" title="%2$s">', $image_url, $term->name );
					break;
